...
(if (and (>= (+ (first (sysinfo 'fw-ver)) (* (second (sysinfo 'fw-ver)) 0.01)) 6.05)) {
    (def bms-discovery-timer (systime))
    (loopwhile (or (< (get-bms-val 'bms-can-id) 0) (< (secs-since bms-discovery-timer) 5)) (sleep 1))
